...
...targets <- list(`__Check_settings_file` = targets::tar_target_raw("settings_path", 
    ...
    input_new_input = targets::tar_target_raw("new_input", quote({
        ...
        command = quote({
            {
                ...
                table_apply_roi <- function(table, roi_column, 
                  roi, use_regex) {
                ...
                raw_table <- table_apply_roi(table = raw_table, 
        ...
        pattern = NULL, iteration = "list"), apply_time_filter = targets::tar_target_raw(name = "collapsed", 
        command = quote({
            {
                library(rutabaga)
