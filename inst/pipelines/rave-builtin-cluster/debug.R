...
##'
Sys.setenv("RAVE_PIPELINE" = normalizePath("/Users/beauchamplab/Dropbox (PENN Neurotrauma)/XiangClusteringProject/raveclusters/inst/pipelines/rave-builtin-cluster"))
